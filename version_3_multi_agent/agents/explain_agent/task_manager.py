...
from version_3_multi_agent.models.task import Message, Task, TextPart, TaskStatus, TaskState
...
class AgentTaskManager(InMemoryTaskManager):
    ...
    async def on_send_task(self, request: SendTaskRequest) -> SendTaskResponse:
        ...
        async with self.lock:                   # Lock access to avoid concurrent writes
            ...
            task.history.append(agent_message.model_dump())  # Append the agent's message to the task history
