...
from version_3_multi_agent.client.client import A2AClient
# Import Task model to represent the full task response
from version_3_multi_agent.models.task import Task
...
class AgentConnector:
    ...
    async def send_task(self, message: str, session_id: str) -> Task:
        ...
        logger.info(f"AgentConnector: received response from {self.name} for task {task_id} in {end - start}")
