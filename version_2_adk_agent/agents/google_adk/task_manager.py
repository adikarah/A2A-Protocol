...
# =============================================================================
# Purpose:
# This file connects your Gemini-powered agent (ExplainAgent) to the task-handling system.
...
from version_2_adk_agent.server.task_manager import InMemoryTaskManager
...
from version_2_adk_agent.models.request import SendTaskRequest, SendTaskResponse
from version_2_adk_agent.models.task import Message, Task, TextPart, TaskStatus, TaskState
...
class AgentTaskManager(InMemoryTaskManager):
    ...
    def __init__(self, agent: ExplainAgent):
